...
HRESULT CCEditBox::CreateMultiline(HWND hParent, HINSTANCE, RECT prect, RECT orect, bool bBorder)
{
    ...
    DWORD dwExStyle = 0;
    if(bBorder) dwExStyle = WS_EX_CLIENTEDGE;
...
HRESULT CCEditBox::Create(HWND hParent, HINSTANCE hInstance, RECT prect, RECT orect, bool bBorder)
{
    CopyRect(&this->prect, &prect);
    CopyRect(&this->orect, &orect);
    this->hParent = hParent;

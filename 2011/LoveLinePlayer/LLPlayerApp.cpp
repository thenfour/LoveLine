...
HRESULT LLPlayerApp::Entry(HINSTANCE hInstance, PCWSTR wszCmdLine)
{
    ...
    */
    ...
    if(FAILED(this->Core.Initialize(this, &this->Splash)))
	{
		// FAILED to initialize the core...
		this->MainWindow.Destroy();
		this->Splash.Destroy();
		MessageBox(0, L"Could not initialize the player core.\r\nMake sure the database isn't currently being used.", NULL, MB_OK | MB_ICONASTERISK);
		return 0;
	}
    ...
    */
    ...
    ShowWindow(this->MainWindow, SW_SHOWNORMAL);
